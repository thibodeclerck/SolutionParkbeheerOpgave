...
namespace ParkBusinessLayer.Model
{
    public class Huis
    {
        ...
        public Huis(int id, string straat, int nr, bool actief)
        {
            Id = id;
            Straat = straat;
            Nr = nr;
        ...
        public Huis(int id, string straat, int nr, bool actief, Park park, List<Huurcontract> huurcontracten) : this(id, straat, nr, actief, park)
        {
            this.huurcontracten = huurcontracten;
        }
